...
{
    ZEND_MODULE_GLOBALS_CTOR(printer, php_printer_init, php_printer_shutdown);
	...
	REGISTER_LONG_CONSTANT("PRINTER_COPIES",				COPIES);
	REGISTER_LONG_CONSTANT("PRINTER_MODE",				MODE);
	REGISTER_LONG_CONSTANT("PRINTER_TITLE",				TITLE);
	REGISTER_LONG_CONSTANT("PRINTER_DEVICENAME",			DEVICENAME);
	REGISTER_LONG_CONSTANT("PRINTER_DRIVERVERSION",		DRIVER_VERSION);
	REGISTER_LONG_CONSTANT("PRINTER_OUTPUT_FILE",		OUTPUT_FILE);
	REGISTER_LONG_CONSTANT("PRINTER_RESOLUTION_Y",		YRESOLUTION);
	REGISTER_LONG_CONSTANT("PRINTER_RESOLUTION_X",		XRESOLUTION);
	REGISTER_LONG_CONSTANT("PRINTER_SCALE",				SCALE);
	REGISTER_LONG_CONSTANT("PRINTER_BACKGROUND_COLOR",	BG_COLOR);
	REGISTER_LONG_CONSTANT("PRINTER_PAPER_LENGTH",		PAPER_LENGTH);
	REGISTER_LONG_CONSTANT("PRINTER_PAPER_WIDTH",		PAPER_WIDTH);

	REGISTER_LONG_CONSTANT("PRINTER_PAPER_FORMAT",		PAPER_FORMAT);
	REGISTER_LONG_CONSTANT("PRINTER_FORMAT_CUSTOM",		0);
	REGISTER_LONG_CONSTANT("PRINTER_FORMAT_LETTER",		DMPAPER_LETTER);
	REGISTER_LONG_CONSTANT("PRINTER_FORMAT_LEGAL",		DMPAPER_LEGAL);
	REGISTER_LONG_CONSTANT("PRINTER_FORMAT_A3",			DMPAPER_A3);
	REGISTER_LONG_CONSTANT("PRINTER_FORMAT_A4",			DMPAPER_A4);
	REGISTER_LONG_CONSTANT("PRINTER_FORMAT_A5",			DMPAPER_A5);
	REGISTER_LONG_CONSTANT("PRINTER_FORMAT_B4",			DMPAPER_B4);
	REGISTER_LONG_CONSTANT("PRINTER_FORMAT_B5",			DMPAPER_B5);
	REGISTER_LONG_CONSTANT("PRINTER_FORMAT_FOLIO",		DMPAPER_FOLIO);

	REGISTER_LONG_CONSTANT("PRINTER_ORIENTATION",			ORIENTATION);
	REGISTER_LONG_CONSTANT("PRINTER_ORIENTATION_PORTRAIT",	DMORIENT_PORTRAIT);
	REGISTER_LONG_CONSTANT("PRINTER_ORIENTATION_LANDSCAPE",	DMORIENT_LANDSCAPE);

	REGISTER_LONG_CONSTANT("PRINTER_TEXT_COLOR",			TEXT_COLOR);
	REGISTER_LONG_CONSTANT("PRINTER_TEXT_ALIGN",			TEXT_ALIGN);
	REGISTER_LONG_CONSTANT("PRINTER_TA_BASELINE",		TA_BASELINE);
	REGISTER_LONG_CONSTANT("PRINTER_TA_BOTTOM",			TA_BOTTOM);
	REGISTER_LONG_CONSTANT("PRINTER_TA_TOP",				TA_TOP);
	REGISTER_LONG_CONSTANT("PRINTER_TA_CENTER",			TA_CENTER);
	REGISTER_LONG_CONSTANT("PRINTER_TA_LEFT",			TA_LEFT);
	REGISTER_LONG_CONSTANT("PRINTER_TA_RIGHT",			TA_RIGHT);
	
	REGISTER_LONG_CONSTANT("PRINTER_PEN_SOLID",			PS_SOLID);
	REGISTER_LONG_CONSTANT("PRINTER_PEN_DASH",			PS_DASH);
	REGISTER_LONG_CONSTANT("PRINTER_PEN_DOT",			PS_DOT);
	REGISTER_LONG_CONSTANT("PRINTER_PEN_DASHDOT",		PS_DASHDOT);
	REGISTER_LONG_CONSTANT("PRINTER_PEN_DASHDOTDOT",		PS_DASHDOTDOT);
	REGISTER_LONG_CONSTANT("PRINTER_PEN_INVISIBLE",		PS_NULL);

	REGISTER_LONG_CONSTANT("PRINTER_BRUSH_SOLID",		BRUSH_SOLID);
	REGISTER_LONG_CONSTANT("PRINTER_BRUSH_CUSTOM",		BRUSH_CUSTOM);
	REGISTER_LONG_CONSTANT("PRINTER_BRUSH_DIAGONAL",		HS_BDIAGONAL);
	REGISTER_LONG_CONSTANT("PRINTER_BRUSH_CROSS",		HS_CROSS);
	REGISTER_LONG_CONSTANT("PRINTER_BRUSH_DIAGCROSS",	HS_DIAGCROSS);
	REGISTER_LONG_CONSTANT("PRINTER_BRUSH_FDIAGONAL",	HS_FDIAGONAL);
	REGISTER_LONG_CONSTANT("PRINTER_BRUSH_HORIZONTAL",	HS_HORIZONTAL);
	REGISTER_LONG_CONSTANT("PRINTER_BRUSH_VERTICAL",		HS_VERTICAL);

	REGISTER_LONG_CONSTANT("PRINTER_FW_THIN",			FW_THIN);
	REGISTER_LONG_CONSTANT("PRINTER_FW_ULTRALIGHT",		FW_ULTRALIGHT);
	REGISTER_LONG_CONSTANT("PRINTER_FW_LIGHT",			FW_LIGHT);
	REGISTER_LONG_CONSTANT("PRINTER_FW_NORMAL",			FW_NORMAL);
	REGISTER_LONG_CONSTANT("PRINTER_FW_MEDIUM",			FW_MEDIUM);
	REGISTER_LONG_CONSTANT("PRINTER_FW_BOLD",			FW_BOLD);
	REGISTER_LONG_CONSTANT("PRINTER_FW_ULTRABOLD",		FW_ULTRABOLD);
	REGISTER_LONG_CONSTANT("PRINTER_FW_HEAVY",			FW_HEAVY);

	REGISTER_LONG_CONSTANT("PRINTER_ENUM_LOCAL",			PRINTER_ENUM_LOCAL);
	REGISTER_LONG_CONSTANT("PRINTER_ENUM_NAME",			PRINTER_ENUM_NAME);
	REGISTER_LONG_CONSTANT("PRINTER_ENUM_SHARED",		PRINTER_ENUM_SHARED);
	REGISTER_LONG_CONSTANT("PRINTER_ENUM_DEFAULT",		PRINTER_ENUM_DEFAULT);
	REGISTER_LONG_CONSTANT("PRINTER_ENUM_CONNECTIONS",	PRINTER_ENUM_CONNECTIONS);
	REGISTER_LONG_CONSTANT("PRINTER_ENUM_NETWORK",		PRINTER_ENUM_NETWORK);
	REGISTER_LONG_CONSTANT("PRINTER_ENUM_REMOTE",		PRINTER_ENUM_REMOTE);
